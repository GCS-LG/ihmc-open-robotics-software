...
public class AStarFootstepPlanner
{
                               ...
                               WaypointDefinedBodyPathPlanHolder bodyPathPlanHolder)
   {
      ...
      this.distanceAndYawHeuristics = new FootstepPlannerHeuristicCalculator(snapper, footstepPlannerParameters.getAStarHeuristicsWeight(), footstepPlannerParameters, bodyPathPlanHolder, edgeData);
