...
public class FootstepPlannerHeuristicCalculator
{
   ...
   {
      midfootPoint.set(node.getOrComputeMidFootPoint(parameters.getIdealFootstepWidth()));
      ...
      double heuristicCost = weight.getAsDouble() * (initialTurnDistance + walkDistance + finalTurnDistance);
      if (edgeData != null)
      {
